...
from backend.services.detection_service import get_detection_service, BEHAVIOR_CLASSES
...
def generate_alerts_for_detection(session_id: int, detections: list, behavior_summary: dict):
    ...
    try:
        ...
        from backend.services.rule_engine import EvaluationContext
...
def launch_desktop_app():
    ...
    try:
        ...
        app_path = launch_os.path.join(project_root, 'desktop', 'detection_app.py')
