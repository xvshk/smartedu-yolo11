...
Usage:
    python scripts/train_optimized_4050.py --data merged_dataset_v2/data.yaml
    python scripts/train_optimized_4050.py --data merged_dataset_v2/data.yaml --model yolo11s
    python scripts/train_optimized_4050.py --data merged_dataset_v2/data.yaml --aggressive  # 更激进的显存优化
"""
import argparse
import logging
import sys
...
示例:
  python scripts/train_optimized_4050.py --data merged_dataset_v2/data.yaml
  python scripts/train_optimized_4050.py --data merged_dataset_v2/data.yaml --preset performance
  python scripts/train_optimized_4050.py --data merged_dataset_v2/data.yaml --epochs 150 --patience 30
        """
    )
...
def main():
    ...
    try:
        ...
        if "CUDA out of memory" in str(e) or "OutOfMemoryError" in str(e):
            ...
            logger.error("  1. python scripts/train_optimized_4050.py --data ... --preset aggressive")
            logger.error("  2. python scripts/train_optimized_4050.py --data ... --batch-size 2 --img-size 416")
