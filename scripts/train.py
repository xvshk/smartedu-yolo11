...
Usage:
    python scripts/train.py --data data.yaml --model yolo11m --epochs 100
    python scripts/train.py --data data.yaml --model yolo11s --epochs 50 --batch-size 32
    python scripts/train.py --resume --weights runs/detect/train/weights/last.pt
"""
import argparse
import logging
import sys
